...
deterministic MLPL point-cloud teaching app is delivered and acceptance remains.
The `native3d-retained-scene` saga completed through step 015, including Model Atlas,
